...
Transformar ele em executável
Note que a cor dele é diferente
ls
sudo chmod +x noip
sudo chmod ugo+x noip (não entendi pra que serve este, mas executei)
update-rc.d noip defaults
ls

```
Como saber se funcionou?<br>
```
service --status-all
```
